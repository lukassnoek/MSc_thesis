...
expInfo = {u'session': u'001', u'participant': u'', u'version': u'', u'order': u''}
...
trainfiles=['sequences/cong_train.xlsx','sequences/incong_train.xlsx']
testfiles=['sequences/cong_test.xlsx','sequences/incong_test.xlsx']
trainlabelsL=['A = \nJanos','A = \nMatthias']
trainlabelsR=['L = \nMatthias','L = \nJanos']
testlabelsL=['A = \nJanos of \nPositief','A = \nMatthias of \nPositief']
testlabelsR=['L = \nMatthias of \nNegatief','L = \nJanos or \nNegatief']
...
text_2 = visual.TextStim(win=win, ori=0, name='text_2',
    text="Je zult woorden plaatjes te zien krijgen die je moet classificeren in categorieen door middel van de 'A' en 'L' toets.\r\n\n\rProbeer zo snel mogelijk te kiezen en tegelijkertijd zo weinig mogelijk fouten te maken.\r\n\n\rDruk op de spatiebalk om verder te gaan",    font='Arial',
...
text_3 = visual.TextStim(win=win, ori=0, name='text_3',
    text="Onthoud:\r\n\r\n1) Labels aan de bovenkant van het scherm geven aan welke toets (A/L) hoort bij welke categorie.\r\n\r\n2) Elk woord en elke afbeelding heeft een correcte categorie.\r\n\r\n3) Houd je beide wijsvingers op de 'A' en 'L' toesten om snel antwoord te kunnen geven.\r\n\r\n4) De taak is nutteloos als je te langzaam antwoord geeft; kies daarom zo snel mogelijk\r\n\r\nDruk op de spatiebalk om te beginnen.",    font='Arial',
...
text = visual.TextStim(win=win, ori=0, name='text',
    text='Bekijk de categorieen bovenaan het scherm.\r\n\r\nPositioneer je wijsvingers op de toetsen (A/L).\r\n\r\nDruk op de spatiebalk om te beginnen.',    font='Arial',
    pos=[0, 0], height=0.1, wrapWidth=None,
    color='white', colorSpace='rgb', opacity=1,
    depth=0.0)
...
Train_pos_neg = data.TrialHandler(nReps=1, method='random', 
    ...
    trialList=data.importConditions('sequences\pos_neg_train.xlsx'),
