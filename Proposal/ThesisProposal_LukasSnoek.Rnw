...
Given that our multivariate analyses employ different statistical techniques (machine learning classifiers and factorial MANOVAs) with each a different method of statistical evaluation, 
